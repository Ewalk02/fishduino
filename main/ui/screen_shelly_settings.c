...
void fishduino_screen_shelly_build(lv_obj_t *parent)
{
    ...
    lv_obj_align(s_lbl_co2_sw, LV_ALIGN_TOP_LEFT, 8, 128);
    switch_id_label(s_lbl_co2_sw, 0);

    lv_obj_t *b1 = lv_btn_create(s_screen);
    lv_obj_set_size(b1, 36, 28);
    lv_obj_align(b1, LV_ALIGN_TOP_LEFT, 120, 124);
    ...
    lv_obj_align(b2, LV_ALIGN_TOP_LEFT, 160, 124);
    ...
    lv_obj_align(s_lbl_filter_sw, LV_ALIGN_TOP_LEFT, 8, 168);
    switch_id_label(s_lbl_filter_sw, 0);

    lv_obj_t *b3 = lv_btn_create(s_screen);
    lv_obj_set_size(b3, 36, 28);
    lv_obj_align(b3, LV_ALIGN_TOP_LEFT, 120, 164);
    ...
    lv_obj_align(b4, LV_ALIGN_TOP_LEFT, 160, 164);
...
void fishduino_screen_shelly_show(void)
{
    ...
    lv_label_set_text(s_label_status, "CO2/filter plug config (NVS)");
